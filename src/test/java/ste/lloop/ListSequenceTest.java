...
public class ListSequenceTest {
    ...
    public void loop_with_step() {
        ...
        new ListSequence<>(list).from(0).to(10).step(2).loop((index, element) -> sb1.append(index).append(element));
        then(sb1.toString()).isEqualTo("0a2c4e6g8i10k");

        // from(10).to(0).step(2) -> 10,8,..,0
        final StringBuilder sb2 = new StringBuilder();
        new ListSequence<>(list).from(10).to(0).step(2).loop((index, element) -> sb2.append(index).append(element));
